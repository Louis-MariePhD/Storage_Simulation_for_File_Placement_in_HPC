...
RECORDER_DATASETS_PATHS = [VPIC_PATH_UNI, VPIC_PATH_NONUNI, MILC_QCD_PARALLEL, PARADIS_HDF5, PARADIS_POSIX]
RECORDER_DATASETS_NAMES = ["VPIC (UNI)", "VPIC (NONUNI)", "MILC QCD (PARALLEL)","PARADIS_HDF5", "PARADIS_POSIX"]
