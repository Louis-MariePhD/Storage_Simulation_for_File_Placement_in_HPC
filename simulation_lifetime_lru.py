...
if __name__ == "__main__":
    ...
    with open(log_file, 'w') as output:
        ...
        policy_tier_sdd = LRU_LifetimeOverunPolicy(tier_ssd, storage, env, traces[0].lifetime_per_fileid)
        policy_tier_hdd = LRU_LifetimeOverunPolicy(tier_hdd, storage, env, traces[0].lifetime_per_fileid)
